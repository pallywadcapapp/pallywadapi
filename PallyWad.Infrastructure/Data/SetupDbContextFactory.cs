...
{
    internal class SetupDbContextFactory : DesignTimeDbContextFactoryBase<SetupDbContext>
    {
        protected override SetupDbContext CreateNewInstance(DbContextOptions<SetupDbContext> options)
        {
